...
export default function Projects() {
    ...
    <div className="font-mono">🔏🔑 A simple, safe and collaborative password manager. This is a personal project, initially planned to solve problems in EAPVC. It was developed (from idea to deploy) in 40 hours.</div>
  ...
  <div className="relative bg-gray-800 text-gray-100 sm:w-6/12 xs:w-full p-6 rounded-xl shadow-lg m-2">
    ...
    <div className="font-mono">📚 This is a complete virtual learning environment designed for mobile-first and transmedia (the content flows in multiple platforms and promotes a lot of user-student generated content). 👨‍🏫 The initial idea came up during my MBA thesis project.</div>
  ...
  <div className="relative bg-gray-800 text-gray-100 sm:w-6/12 xs:w-full p-6 rounded-xl shadow-lg m-2">
    ...
    <div className="my-2 flex flex-wrap justify-content items-center">
      ...
      <a className="btn-code m-2" href="https://github.com/juanmamaffei/ludere">Repo 5</a>
